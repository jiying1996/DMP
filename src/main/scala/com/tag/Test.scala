...
object Test {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var paramsMap = mutable.LinkedHashMap[String, String]()
    paramsMap.put("address", "百度大厦")
    paramsMap.put("output", "json")
    paramsMap.put("ak", "yourak")
    // 调用下面的toQueryString方法，对LinkedHashMap内所有value作utf8编码，拼接返回结果
    // address=%E7%99%BE%E5%BA%A6%E5%A4%A7%E5%8E%A6&output=json&ak=yourak
  ...
  @throws[UnsupportedEncodingException]
  def toQueryString(data: mutable.Map[String, String]): String = {
